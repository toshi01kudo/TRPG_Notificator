...
def main():
    ...
    candidate_event_list = get_info_from_monodraco()
    candidate_event_list_day = get_info_from_daydream()

    ## 条件に合うものをリストアップ。
    event_list = search_event(candidate_event_list) + search_event(candidate_event_list_day)
    ## 日付に合わせてsort
    ...
    gs_text = 'TRPGイベントリスト: https://docs.google.com/spreadsheets/d/' + spread_sheet_key + '/edit?usp=sharing'
